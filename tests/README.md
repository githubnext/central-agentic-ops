...
| --- | --- | --- |
| 🟢 Pass | Pre-activation admission | The actual `.github/cao/admit.sh` authorizes declared packages and fails closed for disabled packages, malformed policy, and unavailable resolver content. |
