...
The root Central Agentic Ops package installs the activity action workflow and indexer. The private `activity/aw.yml` manifest records internal ownership and is not directly installable.
