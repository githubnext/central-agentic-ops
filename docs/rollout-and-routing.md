...
| WikiSkill | `CENTRAL_AGENTIC_OPS_WIKISKILL_ENABLED` | `CENTRAL_AGENTIC_OPS_WIKISKILL_MODE` | `CENTRAL_AGENTIC_OPS_WIKISKILL_MAX_REPOS` | `CENTRAL_AGENTIC_OPS_WIKISKILL_ROLLOUT_PERCENT` |
