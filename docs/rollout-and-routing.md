...
| --- | --- | --- | --- |
| Ambient Context (optional) | `CENTRAL_AGENTIC_OPS_AMBIENT_CONTEXT_MODE` | `CENTRAL_AGENTIC_OPS_AMBIENT_CONTEXT_MAX_REPOS` | `CENTRAL_AGENTIC_OPS_AMBIENT_CONTEXT_ROLLOUT_PERCENT` |
