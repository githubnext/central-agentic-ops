...
- **DLS-VIEW-032:** A `chart` view **MAY** declare Boolean `table`; `false` **MUST** omit the companion data table, while an omitted or `true` value **MUST** include it. Other marks **MUST NOT** declare `table`.
