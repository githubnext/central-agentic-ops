...
| --- | --- | --- | --- |
| `cao-activity-v3` Actions cache | `.github/workflows/activity.yml` | Next activity run and dashboard builder | Complete collection snapshot; latest matching key across runs |
