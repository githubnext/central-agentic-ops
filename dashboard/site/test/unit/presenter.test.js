...
describe('presenter built-in and custom pages', () => {
  ...
  it('renders JSON-declared package and standalone workflow inventory with a topology summary', () => {
    ...
    expect(page?.querySelector('.summary-grid')?.textContent).toBe('Packages1Package workflows2Standalone workflows1Registered workflows3Unconfirmed registrations0');
