...
export const SOURCE_FIELDS = {
  ...
  'github-api-rate-limits': ['observed-at', 'phase', 'operation', 'outcome', 'token-type', 'resource', 'limit', 'used', 'remaining', 'remaining-percent', 'reset-at', 'cache-hydrated', 'cache-bytes', 'cache-files', 'cache-folders', 'rate-limit-error'],
