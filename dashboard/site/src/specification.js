...
export const SOURCE_FIELDS = {
  ...
  'data-health-summary': ['confidence', 'reason', 'affected-domains', 'next-action', 'availability', 'completeness', 'freshness'],
  'data-health-domains': ['domain', 'confidence', 'reason', 'required-sources', 'optional-sources', 'next-action'],
  'data-health-collections': ['operation', 'source', 'state', 'failure-class', 'progress', 'collector-completed-at', 'retrieved-at', 'source-as-of', 'evidence-horizon', 'fallback', 'snapshot-age', 'provenance', 'reason'],
