...
safe-outputs:
  dispatch-workflow:
    workflows: [self-care-accessibility-checker, self-care-code-improvement, self-care-data-acquisition-audit, self-care-dashboard-review, self-care-docs-build-time-investigator, self-care-primer-brand-checker]
    max: 6
...
The single eligible repository contains the documentation site and dashboard maintained by the six workers. Do not discover, rank, or dispatch work to any other repository.
...
Dispatch all six enabled workers for the selected repository. Never dispatch a worker in review mode or for another repository.
...
In `Outcome`, additionally state whether the sole authorized live target was selected and whether all six SelfCare workers were dispatched.
