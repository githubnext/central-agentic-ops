...
env:
  CENTRAL_AGENTIC_OPS_MODE: ${{ vars.CENTRAL_AGENTIC_OPS_EU_CRA_COMPLIANCE_MODE || 'staged' }}
  GH_AW_SAFE_OUTPUT_MODE: ${{ (inputs.safe_output_mode || vars.CENTRAL_AGENTIC_OPS_EU_CRA_COMPLIANCE_MODE || 'staged') == 'preview' && 'staged' || (inputs.safe_output_mode || vars.CENTRAL_AGENTIC_OPS_EU_CRA_COMPLIANCE_MODE || 'staged') }}
  REVIEW_OUTPUT_REPO: ${{ inputs.safe_output_repo || github.repository }}
  SAFE_OUTPUT_REPO: ${{ (inputs.safe_output_mode || vars.CENTRAL_AGENTIC_OPS_EU_CRA_COMPLIANCE_MODE || 'staged') == 'review' && (inputs.safe_output_repo || github.repository) || '' }}
