...
run-name: "${{ github.event_name == 'schedule' && 'AW Maintenance · scheduled' || format('AW Maintenance · {0} · {1}', inputs.target_repo || github.repository, inputs.safe_output_mode || 'review') }}"
