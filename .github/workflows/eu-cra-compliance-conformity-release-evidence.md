...
env:
  ...
  CENTRAL_AGENTIC_OPS_WORKER_MAX_MODE: ${{ vars.CENTRAL_AGENTIC_OPS_EU_CRA_COMPLIANCE_CONFORMITY_RELEASE_EVIDENCE_MAX_MODE || 'review' }}
...
if: >-
  ...
  (vars.CENTRAL_AGENTIC_OPS_EU_CRA_COMPLIANCE_CONFORMITY_RELEASE_EVIDENCE_ENABLED || 'true') == 'true'
