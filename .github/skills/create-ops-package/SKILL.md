...
- Every orchestrator inherits the dedicated `central-agentic-ops.dispatcher.run` OTEL span transitively from `shared/control.md` through `shared/cao.md`; do not duplicate dispatcher telemetry in package workflows.
